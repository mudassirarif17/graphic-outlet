      ...
      <section className="w-[80vw] mx-auto text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl  mb-4 font-medium text-gray-900">Contact Me.
              {/* <br className="hidden lg:inline-block"/>readymade gluten */ }
            </h1>
            <p className="mb-4 leading-relaxed">We would love to hear from you!</p>
            <p className='mb-4'>Whether you have inquiries, feedback, or simply want to connect with us, we are here to listen and engage. Feel free to reach out to us using the following contact information:</p>
            <p className='mb-4'>
