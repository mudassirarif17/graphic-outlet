...
const firebaseConfig = {
  databaseURL: "https://graphic-outlets-default-rtdb.firebaseio.com",
};
...
export class Container extends Component {
  ...
  detailsSubmitHandler = (event) => {
    ...
    set(ref(database, "outlet-comission/" + this.state.id), {
  ...
  render() {
    return (
      <form onSubmit={this.detailsSubmitHandler}>
              ...
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full">
                  <div className="relative">
                    ...
                    <textarea id="message" name="desc" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                  </div>
                </div>
                <div className="p-2 w-full">
                ...
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  <a className="text-blue-500">graphicoutlets@gemail.com</a>
